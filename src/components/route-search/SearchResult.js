...
const SearchResult = ({ routes, idx, handleRouteClick, expanded, stopIdx }) => {
  ...
  return (
    <Accordion
      ...
      classes={{
        root: "search-accordion-root",
        expanded: "search-accordion-expanded",
      }}
    ...
    >
      <AccordionSummary
        classes={{
          root: "search-accordionSummary-root",
          content: "search-accordionSummary-content",
          expanded: "search-accordionSummary-expanded",
        }}
      >
        <ListItemText
            ...
            return (
              ...
              >
                ...
                {serviceType >= 2 && (
                  <Typography
                    variant="caption"
                    className={"search-result-specialTrip"}
                  >
                    {t("特別班")}
                  </Typography>
                )}
