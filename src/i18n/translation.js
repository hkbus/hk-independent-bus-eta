const resources = {
  en: {
    translation: {
      ...
      "sun-side-off": "Off",
      "sun-side-bar": "Colour stroke on each stop",
      "sun-side-icon": "Icon on each stop",
      "sun-side-text": "One line above the stops",
      "sun-side-map": "Bars beside the map",
  ...
  zh: {
    translation: {
      ...
      "color-light": "日照模式",
      "sun-side-off": "關閉",
      "sun-side-bar": "每個站右邊一條色線",
      "sun-side-icon": "每個站右邊出圖示",
      "sun-side-text": "車站上面一句話",
      "sun-side-map": "地圖兩邊出色帶",
      AEL: "機場快綫",
      TCL: "東涌綫",
      TML: "屯馬綫",
      TKL: "將軍澳綫",
