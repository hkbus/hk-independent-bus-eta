const resources = {
  "en": {
    "translation": {
      ...
      "db-renew-text": "Route database has not been updated for 28 days, click here to update",
      ...
      "個性化設定": "Customize",
      "日夜模式、時間格式、路線次序等": "Routes Ordering, Time Format, Theme...",
      "開啟": "On",
      "開啟中...": "Enabling...",
      "關閉": "Off",
  ...
  "zh": {
    "translation": {
      "bad-weather-text": "公共交通及班次或受惡劣天氣影響，以下資料未必反映最新狀況。按此查看官方公佈。",
      ...
      "Route Search caption 3": "App 亦會確認路線頭站有即將出發的車，以減少過量的搜尋結果",
      "recent": "最近搜尋",
      "all": "全部",
      "bus": "巴士",
      "minibus": "小巴",
      ...
      "Source code": "原始碼",
      "We'd like to set analytics cookies that help us improve hkbus.app by measuring how you use it.": "我們希望設置 cookie，了解你如何使用 hkbus.app 來幫助我們改進。",
      "Accept": "好的",
      "Reject": "不要",
      "Collections": "收藏",
      ...
      "Check in": "心情報到",
      "Emotion Chart": "心電圖",
      "How happy were you in the past 24 hours?": "在過去 24 小時，你的開心指數﹖",
      "What environment made you feel most profound in the past 24 hours?": "在過去 24 小時，令你感受最深的環境﹖",
      "Work": "工作",
      "Gathering": "聚會",
      "Exercise": "運動",
      "Leisure": "消閑",
      "Dining": "用餐",
      "Rest": "休息",
      "What are you most grateful for in the past 24 hours?": "在過去 24 小時，你最感恩的對象是﹖",
      "Friend": "朋友",
      "Partner": "伴侶",
      "Family": "家人",
      "Fellow": "伙伴",
      ...
      "What environment made you feel most profound?": "令你感受最深的環境是哪裡？",
